...
public final class WorldUtils {
    ...
    private static final BooleanField<ClientLevel.ClientLevelData> flatWorld = new BooleanField<>(ClientLevel.ClientLevelData.class, false, "isFlat");
    ...
    static {
        ITemperatureHandler TEMP1 = (world, pos) -> world.getBiome(pos).value().getBaseTemperature();
