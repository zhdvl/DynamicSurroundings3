...
public class CapabilityEntityFXData {
	...
	@Nonnull
	public static final Capability<IEntityFX> FX_INFO = CapabilityManager.get(new CapabilityToken<>() {});
	public static final ResourceLocation CAPABILITY_ID = new ResourceLocation(SoundControl.MOD_ID, "entityfx");

	@OnlyIn(Dist.CLIENT)
	public static void register() {
//		CapabilityManager.INSTANCE.injectCapabilities(IEntityFX.class, new NullStorage<>(), EntityFXData::new);
	}
